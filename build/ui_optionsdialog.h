...
public:
    ...
    NoirSharesAmountField *transactionFee;
    QSpacerItem *horizontalSpacer_Main;
    QCheckBox *NoirSharesAtStartup;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        transactionFee = new NoirSharesAmountField(tabMain);
        ...
        NoirSharesAtStartup = new QCheckBox(tabMain);
        NoirSharesAtStartup->setObjectName(QString::fromUtf8("NoirSharesAtStartup"));

        verticalLayout_Main->addWidget(NoirSharesAtStartup);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        NoirSharesAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start NoirShares after logging in to the system.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        NoirSharesAtStartup->setText(QApplication::translate("OptionsDialog", "&Start NoirShares on system login", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the NoirShares client port on the router. This only works when your router supports UPnP and it is enabled.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        mapPortUpnp->setText(QApplication::translate("OptionsDialog", "Map port using &UPnP", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the NoirShares network through a SOCKS proxy (e.g. when connecting through Tor).", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting NoirShares.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        displayAddresses->setToolTip(QApplication::translate("OptionsDialog", "Whether to show NoirShares addresses in the transaction list or not.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
